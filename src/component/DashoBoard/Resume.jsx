...
const Resume = () => {
  ...
  const fetchEmployeeResumes = async (empId) => {
    try {
      setLoading(true);
      const response = await axios.get(`https://admin.managifyhr.com/api/resume/employee/${empId}`);
  ...
  const handleDeleteConfirm = async () => {
    try {
      await axios.delete(`https://admin.managifyhr.com/api/resume/${resumeToDelete.resumeId}`);
              ...
              {resumes.map((resume) => (
                ...
                >
                  ...
                  <div className="flex justify-end space-x-2">
                    <a
                      href={`https://admin.managifyhr.com/uploads/resumes/${resume.resumeFileName}`}
                      target="_blank"
