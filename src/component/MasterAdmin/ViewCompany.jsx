...
const ViewCompany = () => {
  ...
  useEffect(() => {
    ...
    const fetchCompanies = async () => {
      try {
        ...
        const response = await fetch('https://admin.managifyhr.com/api/subadmin/all');
  ...
  const confirmDelete = async () => {
    if (companyToDelete) {
      try {
        ...
        const response = await fetch(`https://admin.managifyhr.com/api/subadmin/delete/${companyToDelete.id}`, {
          method: 'DELETE'
        });
  ...
  const handleSendLoginDetails = async (id) => {
    try {
      ...
      const response = await fetch(`https://admin.managifyhr.com/api/subadmin/send-email/${company.email}`, {
        method: 'POST'
      });
