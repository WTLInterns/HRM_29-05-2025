...
const AddOpenings = () => {
  ...
  const fetchOpenings = async () => {
    setLoading(true);
    try {
      const res = await axios.get(`https://admin.managifyhr.com/api/openings/${subadminId}`);
  ...
  const handleAddOrEdit = async (e) => {
    ...
    try {
      if (editingId) {
        await axios.put(`https://admin.managifyhr.com/api/openings/${subadminId}/${editingId}`, form);
        toast.success("Opening updated successfully!");
      } else {
        await axios.post(`https://admin.managifyhr.com/api/openings/${subadminId}`, form);
  ...
  const confirmDelete = async () => {
    ...
    setLoading(true);
    try {
      await axios.delete(`https://admin.managifyhr.com/api/openings/${subadminId}/${deleteTargetId}`);
