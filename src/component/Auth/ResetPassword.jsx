    ...
    try {
      ...
      if (userType === "masteradmin") {
        ...
        response = await axios.post(
          `https://admin.managifyhr.com/masteradmin/forgot-password/verify?email=${email}&otp=${otp}&newPassword=${newPassword}`
        );
        console.log("Master Admin password reset response:", response.data);
      } else if (userType === "subadmin") {
        // Use Subadmin API for password reset
        response = await axios.post(
          `https://admin.managifyhr.com/api/subadmin/forgot-password/verify?email=${email}&otp=${otp}&newPassword=${newPassword}`
        );
