...
const Profile = () => {
  ...
  useEffect(() => {
    ...
    if (storedUser) {
      ...
      if (parsedUser.email) {
        setPreviewImage(`https://admin.managifyhr.com/masteradmin/profileImg?email=${parsedUser.email}`);
      }
    }
  }, []);
  ...
  const handleEditToggle = () => {
    if (isEditing) {
      ...
      if (userData) {
        ...
        // Reset image preview
        if (userData.email) {
          setPreviewImage(`https://admin.managifyhr.com/masteradmin/profileImg?email=${userData.email}`);
        } else {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.put(
        "https://admin.managifyhr.com/masteradmin/update",
        formDataToSend,
        {
          headers: {
      ...
      if (updatedUser.email) {
        setPreviewImage(`https://admin.managifyhr.com/masteradmin/profileImg?email=${updatedUser.email}`);
      }
